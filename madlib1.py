...
Button(root, text='******', font='arial 15', command=madlib3, bg='ghost white').place(x=70, y=180)
Button(root, text='*********', font='arial 15', command=madlib2, bg='ghost white').place(x=80, y=240)
